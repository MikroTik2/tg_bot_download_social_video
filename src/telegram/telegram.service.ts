...
export class TelegramService extends Telegraf<Context> implements OnModuleInit {
    ...
    async onStart(@Ctx() ctx: Context) {
        return await ctx.replyWithHTML(`👋 Привет - <strong>${ctx.from.first_name}</strong>! Скинь сюда ссылку и я сделаю ВСЕ не я реально сделаю ВСЕ надо будет сосать буду сосать если еще надо будет что сделать сделаю я вообще без понятия АХАХАХА ААХХАА Я СКУФ Я АРИСТОКРАТ Я ШУТНИК Я ДЖОКЕР.`);
    };

    @Help()
    async onHelp(@Ctx() ctx: Context) {
        return await ctx.replyWithHTML("⁉️<b> Если у тебя есть проблемы.</b> \n✉️ <b>Напишите мне</b> <a href='https://t.me/d16ddd348'>@d16ddd348</a><b>.</b>");
    };
